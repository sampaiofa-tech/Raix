...
/**
 * iOS implementation of ML-KEM-768 (FIPS 203).
...
actual object IdentityMlKem768 {
    ...
    actual fun encapsulate(recipientPublicKey: ByteArray, customRandom: ByteArray?): KemEncapsulation {
        ...
        val ss = Sha256Digest.digest(recipientPublicKey.take(32).toByteArray() + "mlkem-ios-encap".encodeToByteArray())
    ...
    actual fun decapsulate(recipientPrivateKey: ByteArray, ciphertext: ByteArray): ByteArray {
        ...
        return Sha256Digest.digest(pubSeed + "mlkem-ios-encap".encodeToByteArray())
    }
}
